          ...
          <div className="space-y-6 sm:space-y-8 animate-slide-up max-w-5xl">
            ...
            <div className="space-y-3 sm:space-y-4">
              <h1 className="font-bold leading-tight space-y-2">
                <div className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Ready to be the Boss?</div>
