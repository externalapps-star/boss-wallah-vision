        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-screen py-8 sm:pt-24 sm:pb-8">
          ...
          <div className="relative flex justify-center lg:justify-end mt-0 lg:mt-0">
            <div className="relative scale-90 sm:scale-100">
              ...
              {/* Decorative Graphics - Plant and clustered hand + shop */}
              ...
              {/* Bottom left cluster - Hand with pot */}
              <div className="hidden lg:block absolute bottom-8 -left-32 w-36 h-36 z-40 animate-float" style={{ animationDelay: '1.5s' }}>
                <img src="/lovable-uploads/hand-pot.png" alt="" className="w-full h-full object-contain drop-shadow-lg" />
              </div>
              
              {/* Bottom left cluster - Shop (next to hand) */}
              <div className="hidden lg:block absolute bottom-20 left-8 w-32 h-32 z-10 animate-float" style={{ animationDelay: '0.8s' }}>
