      ...
      <div className="section-container relative z-10">
        ...
        <div id="newsletter" className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            <div className="relative bg-background/60 backdrop-blur-sm border border-primary/20 rounded-2xl p-8 shadow-none hover:shadow-xl hover:border-primary/30 transition-all duration-300">
              {!isSubscribed ? (
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  <div className="flex flex-col md:flex-row gap-3">
                      <input 
                        ...
                        className="flex-1 px-4 py-2.5 md:py-3 h-11 md:h-[47px] rounded-lg md:rounded-xl bg-card border border-border/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary text-foreground placeholder:text-muted-foreground transition-all duration-300"
                      />
                      <Button 
