  ...
  const mainFeatures = [
    {
      ...
      customImage: "/lovable-uploads/idea-bulb.png",
    ...
    },
    {
      ...
      customImage: "/lovable-uploads/compass.png",
    ...
    },
    {
      ...
      customImage: "/lovable-uploads/growth-chart.png",
    ...
    },
    {
      ...
      customImage: "/lovable-uploads/growth-bar.png",
    ...
    },
    {
      ...
      customImage: "/lovable-uploads/globe.png",
    ...
    },
    {
      ...
      customImage: "/lovable-uploads/policy-document.png",
            ...
            <div key={index} className="group relative">
              ...
              <div className="relative bg-card backdrop-blur-sm border border-border/40 rounded-3xl p-4 sm:p-8 h-full shadow-[0_8px_30px_-8px_rgba(0,0,0,0.12)] hover:shadow-[0_20px_60px_-15px_rgba(var(--primary-rgb),0.4)] transition-all duration-500 group-hover:-translate-y-2 group-hover:bg-card/80 group-hover:border-primary/60 group-hover:shadow-[0_25px_70px_-20px_rgba(var(--primary-rgb),0.5)]">
                ...
                <div className="flex items-start space-x-3 sm:space-x-4 mb-3 sm:mb-6">
                  <div className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl flex items-center justify-center border border-primary/30 group-hover:scale-110 group-hover:rotate-3 group-hover:border-primary/60 group-hover:shadow-[0_0_30px_rgba(var(--primary-rgb),0.3)] transition-all duration-300 p-2">
                    <img 
